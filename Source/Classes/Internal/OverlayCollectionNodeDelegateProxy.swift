...
class OverlayCollectionNodeDelegateProxy: NSObject, ASCollectionDelegate {

    private var scrollViewObservation: NSKeyValueObservation?
    private weak var originalDelegate: ASCollectionDelegate?
    private weak var scrollView: ASCollectionNode?
    ...
    func forward(to delegate: OverlayScrollViewDelegate, delegateInvocationsFrom scrollView: ASCollectionNode) {
